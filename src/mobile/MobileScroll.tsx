  ...
  return (
    ...
    >
      <div
        ...
        onPointerDown={isNative ? undefined : handlePointerDown}
        onPointerMove={isNative ? undefined : handlePointerMove}
        onPointerUp={isNative ? undefined : endDrag}
        onPointerCancel={isNative ? undefined : endDrag}
        onClickCapture={isNative ? undefined : suppressClickAfterDrag}
      >
        <div
